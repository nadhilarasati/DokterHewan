            ...
            <div class="col-md-8">
                <div style="margin-top:20px">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="namaHewan" class="form-control" id="" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="jenisHewan" class="col-sm-4 col-form-label">Jenis Hewan</label>
                        <div class="col-sm-6">
                            <input type="text" name="jenisHewan" class="form-control" id="" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="tanggalLahir" class="form-control" id="" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="ras" class="form-control" id="" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="warna" class="form-control" id="" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="status" class="form-control" id="" readonly>
                        </div>
                    </div>
                </div>
            </div>
